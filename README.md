...
<p align="center">
      ...
      >
        <title id="titleId">Abhinav Shrivastav's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 6, Total Commits  (last year) : 174, Total PRs: 0, Total Issues: 0, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 224.41615445618885;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Abhinav Shrivastav's GitHub Stats</text>
    </g>
      </g>
